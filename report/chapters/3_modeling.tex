...
\begin{figure}[ht]
	...
	\begin{minipage}{0.47\textwidth}
		...
		\caption{Session Support Tuning}
...
In addition, interactive plot for session hyper-parameter turning was generated using \textbf{plotly} library. A static version of which is provided in \autoref{fig:plotly_session}.
