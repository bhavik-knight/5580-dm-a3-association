...
\subsection[Comparisons]{Benchmark Results: The Apriori Advantage}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\linewidth]{figures/performance_benchmarking_log.pdf}
	\label{fig:arm_benchmark}
	\caption{Apriori v FPG Performance Comparison}
\end{figure}


\subsection[Why Apriori is better?]{The Insight: Sparsity and Shallow Tree Depth}
...
\subsection[When to use FP-Growth?]{The Crossover Theory: When FP-Growth Becomes Superior}
